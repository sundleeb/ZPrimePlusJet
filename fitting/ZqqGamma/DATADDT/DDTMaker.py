...
def ComputeDDT(name, point, nPtBins, nRhoBins, H):
	DDT = TH2F(name, "", nRhoBins, -7.5, -2.0, nPtBins, 200, 800)
	DDT.SetStats(0)
...
if __name__ == '__main__':
	...
	H3 = TH3F("H3", ";Jet #rho;Jet p_{T} (GeV)", RB, -7.5, -2.0, PB, 200., 800., 750, 0., 0.75)
	H31 = TH3F("H31", ";Jet #rho;Jet p_{T} (GeV)", RB, -7.5, -2.0, PB, 200., 800., 750, 0., 0.75)
	H32 = TH3F("H32", ";Jet #rho;Jet p_{T} (GeV)", RB, -7.5, -2.0, PB, 200., 800., 750, 0., 0.75)
	H33 = TH3F("H33", ";Jet #rho;Jet p_{T} (GeV)", RB, -7.5, -2.0, PB, 200., 800., 750, 0., 0.75)
	H3.SetStats(0)
	H31.SetStats(0)
	H32.SetStats(0)
	H33.SetStats(0)
	...
	p = Pool(22)
	SMOOTH = TH2F("SmooDDT", ";Jet #rho;Jet p_{T} (GeV)", nRB, -7.5, -2.0, nPT, 200., 800.)
	SMOOTH.SetStats(0)
	SMOOTH1 = TH2F("SmooDDT1", ";Jet #rho;Jet p_{T} (GeV)", nRB, -7.5, -2.0, nPT, 200., 800.)
	SMOOTH2 = TH2F("SmooDDT2", ";Jet #rho;Jet p_{T} (GeV)", nRB, -7.5, -2.0, nPT, 200., 800.)
	SMOOTH3 = TH2F("SmooDDT3", ";Jet #rho;Jet p_{T} (GeV)", nRB, -7.5, -2.0, nPT, 200., 800.)
