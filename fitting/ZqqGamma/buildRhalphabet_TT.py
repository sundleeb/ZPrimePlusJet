...
class dazsleRhalphabetBuilder: 
	...
	def makeWorkspace(self,iOutput,iDatas,iFuncs,iVars,iCat="cat0",iShift=True):
		...
		interpolatedMasses = []#15.,20.,30.,35.,40.,45.,55.,60.0,65.,70.,80.,85.,90.0,95.,105.,110.0,115.,120.,130.,140.,150.,175.]
...
def main(options,args):
	...
	dazsleRhalphabetBuilder(hpass,hfail,f, options.np, options.nr);
...
if __name__ == '__main__':
	...
	parser.add_option('--input', dest='input', default = 'ZGammaFermiTTSBTemplates.root',help='directory with data', metavar='idir')
