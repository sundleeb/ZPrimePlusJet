...
def main(options,args):
	...
	msd_binBoundaries=[]
	for i in range(0,41): msd_binBoundaries.append(0+i*5)
	print msd_binBoundaries
	pt_binBoundaries = [200, 230, 254, 290, 362, 800]#[200, 228, 252, 288, 360, 800]
...
if __name__ == '__main__':
	...
	parser.add_option("--lumi", dest="lumi", type=float, default = 35.8,help="luminosity", metavar="lumi")
	...
	parser.add_option('--mass', dest='mass', default = '50',help='choice is either prefit, fit_sb or fit_b', metavar='fit')
